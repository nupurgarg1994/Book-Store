...
import com.nupur.mystore.exception.UserException;
import com.nupur.mystore.pojo.Customer;
import com.nupur.mystore.validator.UserValidator;

@Controller
@RequestMapping("/user/*")
public class UserController {
	
	String useremail = "nupurgarg567@gmail.com";
	...
	public void sendEmail(String useremail, String message) {
        try {
            ...
            email.setAuthenticator(new DefaultAuthenticator("nupurgarg567@gmail.com", "alarmclock"));
            ...
            email.addTo("lnu.n@husky.neu.edu");
            email.send();
	...
	protected ModelAndView registerNewUser(HttpServletRequest request,  @ModelAttribute("customer") Customer customer, BindingResult result) {
		...
		try {
	        ...
	        try {
	            String str = "nupurgarg567@gmail.com" + "&key1="
	                    + randomNum1 + "&key2=" + randomNum2;
	            
	            sendEmail("nupurgarg567@gmail.com",
